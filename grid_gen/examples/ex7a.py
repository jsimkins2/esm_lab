...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 20 08:15:15 2021
...
wrkDir = '/Users/james/Downloads/cali/'
inputDir = '/Users/james/Downloads/'
...
ds.addDataSource({
    'GEBCO_2020': {
            'url' : '/Users/james/Downloads/GEBCO_2020.nc',
            'variableMap' : {
                    'lat': 'lat',
                    'lon': 'lon',
                    'depth' : 'elevation'
...
if os.path.isfile(bathyGridFilename):
    ...
    bathyGrids = grd.computeBathymetricRoughness(dsName='/Users/james/Downloads/GEBCO_2020.nc', depthName="elevation", 
    ...
    grd.applyEvalMap(dsName='/Users/james/Downloads/GEBCO_2020.nc', dsData=bathyGrids)
